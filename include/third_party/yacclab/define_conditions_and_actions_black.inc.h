...
#define CONDITION_B img_row_prev_prev[c-1]==BLACK_COLOR_VALUE
#define CONDITION_C img_row_prev_prev[c]==BLACK_COLOR_VALUE
#define CONDITION_D img_row_prev_prev[c+1]==BLACK_COLOR_VALUE
#define CONDITION_E img_row_prev_prev[c+2]==BLACK_COLOR_VALUE

#define CONDITION_G img_row_prev[c-2]==BLACK_COLOR_VALUE
#define CONDITION_H img_row_prev[c-1]==BLACK_COLOR_VALUE
#define CONDITION_I img_row_prev[c]==BLACK_COLOR_VALUE
#define CONDITION_J img_row_prev[c+1]==BLACK_COLOR_VALUE
#define CONDITION_K img_row_prev[c+2]==BLACK_COLOR_VALUE

#define CONDITION_M img_row[c-2]==BLACK_COLOR_VALUE
#define CONDITION_N img_row[c-1]==BLACK_COLOR_VALUE
#define CONDITION_O img_row[c]==BLACK_COLOR_VALUE
#define CONDITION_P img_row[c+1]==BLACK_COLOR_VALUE

#define CONDITION_R img_row_fol[c-1]==BLACK_COLOR_VALUE
#define CONDITION_S img_row_fol[c]==BLACK_COLOR_VALUE
#define CONDITION_T img_row_fol[c+1]==BLACK_COLOR_VALUE
